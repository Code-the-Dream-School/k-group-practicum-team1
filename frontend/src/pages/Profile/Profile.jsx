...
const Profile = () => {
  ...
  if (error)
    return (
      <div className="w-full max-w-md mx-auto bg-white rounded-xl shadow-lg p-8 text-center text-red-600">{error}</div>
    );
  if (!user) {
    return (
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
      <h1 className="text-2xl font-bold text-indigo-700 mb-1">Your Profile</h1>
